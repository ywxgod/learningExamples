    ...
    _createClass(AjaxService, [{
        ...
        value: function promise(url) {
            ...
            if (method == 'post') {
                var d = opts.data || {};
                delete opts.data;
                return this._axios[method](url, d, opts);
            }
...
var _VueMediator = __webpack_require__(6);

var _EventBus = __webpack_require__(1);

var _BaseModel = __webpack_require__(9);

var _AjaxCommand = __webpack_require__(10);

var _AjaxService = __webpack_require__(4);

var _BaseCommand = __webpack_require__(0);

var _SimpleCommand = __webpack_require__(13);
...
exports.default = {
    ...
    AjaxCommand: _AjaxCommand.AjaxCommand,
    AjaxService: _AjaxService.AjaxService,
    BaseCommand: _BaseCommand.BaseCommand,
    SimpleCommand: _SimpleCommand.SimpleCommand,
    IDUtil: _IDUtil.IDUtil,
    FunUtil: _FunUtil.FunUtil,
    VueMediator: _VueMediator.VueMediator,
    executeCommand: _VueMediator.executeCommand,
    mapCommands: _VueMediator.mapCommands
};
...
var BaseMediator = exports.BaseMediator = function () {
    ...
    _createClass(BaseMediator, [{
        ...
        value: function _addEvtMap(target, eType, callback, data) {
            ...
            return { traceId: traceId, target: target, eType: eType, handler: handler };
        }
    }, {
        key: 'off',
        value: function off(eId) {
